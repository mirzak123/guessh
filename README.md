...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| CREATE_MATCH    | {"type": "CREATE_MATCH", "mode": single, "format": string, "rounds": number, "wordLength": number, secondsPerTurn: number, "playerName"?: string} | playerName required only in multiplayer mode |
...
| MATCH_STARTED           | {"type": "MATCH_STARTED", "matchId": string, "format": string, "rounds": number, "wordLength": number, secondsPerTurn: number, "opponentName"?: string} | opponentName is only included in MULTI_REMOTE mode |
